...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"ראשון",sLast:"אחרון",sNext:"הבא",sPrevious:"הקודם"},sEmptyTable:"אין מידע זמין",sInfo:"מציג מ _START_ עד _END_ מתוך _TOTAL_ רשומות",sInfoEmpty:"מציג 0 עד 0 מתוך 0 רשומות",sInfoFiltered:"(מסנן מתוך _MAX_ רשומות)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"מציג _MENU_ רשומות",sLoadingRecords:"טוען..",sProcessing:"מחשב..",sSearch:"חפש:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"לא נמצאו רשומות מתאימות"},
