                        ...
                        <form class="form p-t-20 form-valide" action="#" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control ignore" rows="10" id="addheaders" style="height: 60px;"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-question-circle"></i></div>
                                    <textarea class="form-control ignore" rows="10" id="addparms" style="height: 60px;"></textarea>
